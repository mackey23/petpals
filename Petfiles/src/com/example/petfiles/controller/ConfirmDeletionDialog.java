...
public class ConfirmDeletionDialog {
	...
	public static void showConfirmDeleteDialogForTask(Activity sourceActivity, Task task, DatabaseHandler databaseHandler){
		...
		.setPositiveButton("Yes",
				new ConfirmDeleteDialogForTaskPositiveButtonListener(sourceActivity, task, databaseHandler))
	...
	private static class ConfirmDeleteDialogForTaskPositiveButtonListener implements OnClickListener{
		...
		// constructor
		public ConfirmDeleteDialogForTaskPositiveButtonListener(Activity sourceActivity, Task task, DatabaseHandler databaseHandler){
